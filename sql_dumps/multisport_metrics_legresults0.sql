...
CREATE TABLE `legresults` (
  ...
  CONSTRAINT `fk_athleteid_lr` FOREIGN KEY (`AthleteID`) REFERENCES `athlete` (`AthleteID`) ON DELETE CASCADE ON UPDATE CASCADE,
